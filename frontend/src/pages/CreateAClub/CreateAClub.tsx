...
const backendUrl =
  import.meta.env.VITE_BACKEND_URL || "https://clubstop.onrender.com";
  ...
  const filteredFlairs = flairSrch.trim()
    ? flairs
        ?.filter((flair) =>
          flair.flair_name
            .toLowerCase()
            .includes(flairSrch.trim().toLowerCase())
        )
        .slice(0, 3)
    : null;
            ...
            <form onSubmit={handleSubmit}>
                ...
                {filteredFlairs && filteredFlairs.length > 0 ? (
                  <div className="searchItems">
                    {filteredFlairs.map((flair, idx) => (
                      <div
                        onClick={() => setSelected(flair.flair_name)}
              ...
              {selected ? (
                <div className="selectedBox">
                  <h1 className="selectedFlair">Selected:</h1>{" "}
                  <Flair
                    Flair={selected}
                    dlt={false}
                    primary={true}
              ...
              <div className="social-links-section">
                <h3 className="social-links-title">Club Links</h3>
          ...
          <div className="club-creation-card">
            <div className="success-section">
              ...
              <p className="success-description">
                Your club has been successfully created and is ready for
                members.
              </p>
              <button
